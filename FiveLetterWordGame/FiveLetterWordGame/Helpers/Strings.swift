...
struct StringCentral {
    ...
    static let infoParagraph2 = "Click once to turn a letter light grey if you know it's not in the word. Click again for a letter you're uncertain about to become yellow. And click a third time to make letters you're sure about green! Click the reset button in the top right to return them all to starting state."
